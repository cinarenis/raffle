          ...
          <div class="x_content">
            ...
            <form action="../raffle/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="urun_ad" name="urun_ad" placeholder="Ürün Ad" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="urun_keyword" name="urun_keyword" placeholder="Ürün Keyword" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="urun_fiyat">Ürün Fiyat
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="urun_fiyat" name="urun_fiyat" placeholder="Ürün Fiyat (Kişi Sayısı = Fiyat+(Fiyat/10))" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
